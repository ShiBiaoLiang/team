...
<html>
  <head>
    ...
    <title>My JSP 'ComInterest.jsp' starting page</title>
...
<tr>
  ...
  <tr>
   <td> <label for="inputtext3 control-label">年数</label></td>
...
<tr>
   <td> <label for="inputtext3 control-label">复利总值:</label></td>
   <td> <input type="text" class="control" id="exampleInputPassword2" value="<%=amount %>"></td>
</tr>


 <tr>
  <td><a href="Compound_interest_calculator.jsp">返回</a></td>
   </tr>
   </table>
</form>
  </body>
